...
#Autostart
mv autostart/org.mozilla.firefox.desktop ~/.config/autostart/
mv autostart/discord.desktop ~/.config/autostart/
mv autostart/steam.desktop ~/.config/autostart/
mv autostart/OpenRGB.desktop ~/.config/autostart/ 
mv autostart/spoof.desktop ~/.config/autostart/ && wget https://github.com/xvzc/SpoofDPI/releases/download/v0.12.0/spoofdpi-linux-amd64.tar.gz && tar -xzvf spoofdpi-linux-amd64.tar.gz && sudo mv spoofdpi /usr/local/
